...
function theme_setup() {
	...
	register_nav_menus( array(
		'menu-1' => esc_html__( 'Left', 'theme' ),
		'menu-2' => esc_html__( 'Right', 'theme' ),
	) );
...
function theme_widgets_init() {
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Footer logo', 'theme' ),
        'id'            => 'col-2',
        'description'   => esc_html__( 'Add widgets here.', 'theme' ),
        'before_widget' => '<section id="%1$s" class="widget %2$s">',
        'after_widget'  => '</section>',
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Twitter widget', 'theme' ),
        'id'            => 'col-3',
        'description'   => esc_html__( 'Add widgets here.', 'theme' ),
        'before_widget' => '<section id="%1$s" class="widget %2$s">',
        'after_widget'  => '</section>',
...
function theme_scripts() {
  ...
  // Scripts
    wp_enqueue_script( 'slick-script', get_template_directory_uri() . '/assets/scripts/slick.js', array(), false, true );
    wp_enqueue_script( 'scroll', get_template_directory_uri() . '/assets/scripts/jquery.scrollify.js', array(), false, true );
    wp_enqueue_script( 'sorter', get_template_directory_uri() . '/assets/scripts/datatables.min.js', array(), false, true );
