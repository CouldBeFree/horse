    ...
    <section id="home" class="home">
      ...
      <div class="main-container">
        <ul class="social-holder">
          ...
          <li>
            <a href="https://twitter.com/Hennigracing?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor" target="_blank" class="link-item"><span class="icon icon-twitter"></span></a>
          </li>
          <li>
            <a href="https://www.facebook.com/groups/377719425678210/about/" target="_blank" class="link-item"><span class="icon icon-facebook"></span></a>
          </li>
        </ul>
      </div>
    </section>
    ...
    <section class="contact" id="contact" style="background: url('<?php echo CFS()->get( 'contact_background' ); ?>') no-repeat; background-size: cover; background-position: 50% 50%">
      <div class="main-container">
        ...
        <ul class="social-holder">
          ...
          <li>
            <a href="https://twitter.com/Hennigracing?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor" class="link-item" target="_blank"><span class="icon icon-twitter"></span></a>
          </li>
          <li>
            <a href="https://www.facebook.com/groups/377719425678210/about/" target="_blank" class="link-item"><span class="icon icon-facebook"></span></a>
          </li>
